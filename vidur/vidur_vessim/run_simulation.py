...
def run_vessim_simulation(
    data, sim_start_time, sim_end_time, step_size, solar_scale, 
    battery_capacity, battery_initial_soc, battery_min_soc, 
    output_file, analysis_type, location
):
    ...
    solar_signal = vs.HistoricalSignal.load(
        "solcast2022_global", column=location,
    ...
    carbon_intensity_signal = vs.HistoricalSignal.load(
        ...
        params={"start_time": sim_start_time}
    )
