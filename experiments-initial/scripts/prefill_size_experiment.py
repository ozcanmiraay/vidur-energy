...
def run_simulation(prefill_size: int, batch_size_cap: int, output_dir: str):
    ...
    cmd = [
        ...
        "--fixed_request_length_generator_config_prefill_tokens", str(prefill_size),
        "--fixed_request_length_generator_config_decode_tokens", "32",  # Fixed small decode size
...
def main():
    ...
    for prefill_size in prefill_sizes:
        ...
        try:
            ...
            batch_size_cap = min(128, 4096 // prefill_size)  # Adjust batch size based on prefill size
